...
namespace Coquo.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public IngredientsController(KitchenContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IngredientID,IngredientName,IngredientDescription")] Ingredient ingredient)
        {
